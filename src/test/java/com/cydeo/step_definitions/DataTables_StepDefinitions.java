...
public class DataTables_StepDefinitions {
    ...
    public void user_should_see_below_list(List<String> fruitAndVegetables) {
        ...
        System.out.println("fruitAndVegetables = " + fruitAndVegetables);
    ...
    public void i_will_share_my_favorites(List<String> listOfDog) {
        System.out.println("listOfDog = " + listOfDog);
        System.out.println(listOfDog.get(1));
...
DropdownsPage dropdownsPage=new DropdownsPage();
    ...
    public void user_should_see_below_info_in_month_dropdown(List<String>expectedMonths) {
        ...
        List<String>actualMonths= BrowserUtils.dropdownOptions_as_STRING(dropdownsPage.montDropdown);
