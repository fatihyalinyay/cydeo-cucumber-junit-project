...
public class Etsy_StepDefinitions {
    ...
    @When("User should  see title is as expected.")
    public void user_should_see_title_is_as_expected() {

        String expectTitle="Etsy - Shop for handmade, vintage, custom, and unique gifts for everyone";
        BrowserUtils.verifyTitle(expectTitle);
